            ...
            return (
              <div key={item?.path} className="relative group">
                <button
                  ...
                  className={`w-full flex items-center space-x-3 px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-150 micro-interaction ${
                    isActive
          ...
          {navigationItems?.slice(0, 4)?.map((item) => {
            ...
            return (
              <button
                key={item?.path}
                onClick={() => handleNavigation(item?.path)}
                className={`flex flex-col items-center justify-center space-y-1 px-2 py-1 rounded-lg transition-colors duration-150 ${
                  isActive
